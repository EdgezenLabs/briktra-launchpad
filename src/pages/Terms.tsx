    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-24 md:px-6 md:py-32">
        <div className="mx-auto max-w-3xl prose prose-slate dark:prose-invert">
          <h1 className="mb-8 font-display text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary to-orange-400">Terms & Conditions</h1>
          ...
          <div className="space-y-6 text-foreground">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-primary">3. User Responsibilities</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-primary">4. Limitation of Liability</h2>
